...
export class UsersController {
  ...
  @ApiOperation({
    ...
    description: 'Creates a new user (Admin/Superuser only)',
  })
  @ApiBody({
    type: CreateUserDto,
  ...
  @ApiOperation({
    ...
    description: 'Returns a paginated list of users (Admin/Superuser only)',
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiOperation({
    summary: 'Delete user',
    description: 'Permanently deletes a user (Superuser only)',
  })
  @ApiParam({
    name: 'id',
    description: 'User ID (UUID)',
  ...
  @ApiResponse({
    status: 400,
    description: 'Bad request (user has associated devices)',
    type: UserErrorResponseDto,
  })
